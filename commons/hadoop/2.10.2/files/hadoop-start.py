...
if args.master:
    ...
    os.system(f"{HADOOP_HOME}/sbin/hadoop-daemon.sh --config {HADOOP_HOME}/etc/hadoop --script hdfs start namenode")
    print("Yarn ResourceManager start:")
    os.system(f"{HADOOP_HOME}/sbin/yarn-daemon.sh --config {HADOOP_HOME}/etc/hadoop start resourcemanager")
    print("Yarn ProxyServer and HistoryServer start:")
    os.system(f"{HADOOP_HOME}/sbin/mr-jobhistory-daemon.sh --config $HADOOP_PREFIX/etc/hadoop start historyserver")
 
elif args.slave:
    print("HDFS DataNode start")
    os.system(f"{HADOOP_HOME}/sbin/hadoop-daemon.sh --config {HADOOP_HOME}/etc/hadoop --script hdfs start datanode")
    print("YARN NodeManager start")
    os.system(f"{HADOOP_HOME}/sbin/yarn-daemon.sh --config {HADOOP_HOME}/etc/hadoop start nodemanager")
