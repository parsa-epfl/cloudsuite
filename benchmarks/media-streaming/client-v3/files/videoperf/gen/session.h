...
/* Given a connection object, return last call that was added
 * to the connection. This is used by call_stats when a 
 * connection times out before the connection is established */
extern Call *session_get_last_call (Conn *conn);
